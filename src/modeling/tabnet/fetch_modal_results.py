...
FILES = [
    ...
    ("tabnet-pead-output", "e30_results.parquet",              "e30_results.parquet"),
    ("tabnet-pead-output", "e30_per_fold_summary.parquet",     "e30_per_fold_summary.parquet"),
    ("tabnet-pead-output", "e30_histories_clf.json",           "e30_histories_clf.json"),
    ("tabnet-pead-output", "e30_histories_reg.json",           "e30_histories_reg.json"),
    ("tabnet-pead-output", "e30_feature_importance.json",      "e30_feature_importance.json"),
    ("tabnet-pead-output", "e30_attention_masks.json",         "e30_attention_masks.json"),
]
